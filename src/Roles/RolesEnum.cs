...
static class Foo
{
    static readonly Dgmjr.Identity.Abstractions.IRole r = Dgmjr.Identity.Role.Admin.Instance;
}

[GenerateEnumerationRecordStruct(nameof(Role), $"{nameof(Dgmjr)}.{nameof(Dgmjr.Identity)}")]
public enum Role
{
    ...
    [Display(Name = Names.Admin, Description = "The administrator role")]
    Admin = 1,

    /// <summary>The <inheritdoc cref="Administrator" path="/value" /> role</summary>
    ...
    [Display(Name = Names.Administrator, Description = "The administrator role")]
    Administrator = 2,

    /// <summary>The <inheritdoc cref="GroupAdministrator" path="/value" /> role</summary>
    ...
    [Display(Name = Names.GroupAdministrator, Description = "The group administrator role")]
    ...
    [Display(Name = Names.User, Description = "The user role")]
    User = 5,

    /// <summary>The <inheritdoc cref="GroupMember" path="/value" /> role</summary>
    ...
    [Display(Name = Names.GroupMember, Description = "The group member role")]
    GroupMember = 6,
    ...
    [Display(Name = Names.Voter, Description = "The voter role")]
    Voter = 7,
    ...
    [Display(Name = Names.Contestant, Description = "The contestant role")]
    Contestant = 8,

    /// <summary>The <inheritdoc cref="AnonymousUser" path="/value" /> role</summary>
    ...
    [Display(Name = Names.Anonymous, Description = "The anonymous user role")]
    AnonymousUser = 9
}
