...
public enum Role
{
    ...
    [Display(
        Name = Names.Admin, Description = "The administrator role")]
    Admin = 1,
    ...
    [Display(
        ...
        Description = "The group administrator role")]
    ...
    [Display(
        Name = Names.User, Description = "The user role")]
    User = 5,
    ...
    [Display(
        ...
        Description = "The group member role")]
    GroupMember = 6,
    ...
    [Display(
        Name = Names.Voter, Description = "The voter role")]
    Voter = 7,
    ...
    [Display(
        ...
        Description = "The contestant role")]
    Contestant = 8,
    ...
    [Display(
        ...
        Description = "The anonymous user role")]
    AnonymousUser = 9
}
