...
public static class IdentityDependencyInjectionExtensions
{
    ...
    AddIdentity<TKey, TUser, TRole>(this WebApplicationBuilder builder,
    ...
    {
        _ = builder.Services
                .AddSingleton<IPassphraseGenerator, PassphraseGenerator>();
        ...
        var idBuilder =
            builder.Services
                .AddIdentityCore<TUser>(
                    options => //.AddIdentity<User, Role>(options =>
                               // _ = builder.Services.AddIdentity<User,
                               // Role>(options =>
                    {
                ...
                .AddClaimsPrincipalFactory<
                    DgmjrId.UserClaimsPrincipalFactory<TUser>>()
