...
//  *   Modified: 2023-03-29-11:42:22
//  * 
// [Display(Name = ClaimTypeUris.*   Author: David G. Moore, ShortName = nameof(*   Author: David G. Moore))]
// [Uri(ClaimTypeUris.*   Author: David G. Moore)]
// *   Author: David G. Moore, Jr. <david@dgmjr.io>
//  *   
// [Display(Name = ClaimTypeUris.*   Copyright © 2022 - 2023 David G. Moore, Jr., ShortName = nameof(*   Copyright © 2022 - 2023 David G. Moore, Jr.))]
// [Uri(ClaimTypeUris.*   Copyright © 2022 - 2023 David G. Moore, Jr.)]
...
//     [Display(Name = ClaimTypeUris.DenyOnlyPrimaryGroupSid, ShortName = nameof(DenyOnlyPrimaryGroupSid))]
...
//     [Display(Name = ClaimTypeUris.DenyOnlyWindowsDeviceGroup, ShortName = nameof(DenyOnlyWindowsDeviceGroup))]
