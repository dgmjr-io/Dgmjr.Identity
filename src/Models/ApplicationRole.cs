...
public partial class ApplicationRole<TKey>
    : ApplicationIdentityEntity<TKey>,
      IIdentityRole<ApplicationUser<TKey>, ApplicationRole<TKey>, TKey,
  ...
  object IIdentifiable.Id { get => Id; }
  ...
  public virtual ICollection<ApplicationUser<TKey>> Users {
      get; set; } = new Collection<ApplicationUser<TKey>>();
  public virtual ICollection<ApplicationUserRole<TKey>> UserRoles {
      get; set; } = new Collection<ApplicationUserRole<TKey>>();
  public virtual ICollection<ApplicationClaimType<TKey>> ClaimTypes {
      get; set; } = new Collection<ApplicationClaimType<TKey>>();
}

public class ApplicationRole : ApplicationRole<long> {}

public record struct RoleInsertDto
(string Name, uri Uri, string Description) {
  public RoleInsertDto() : this(string.Empty, uri.Empty, string.Empty) {}
}
