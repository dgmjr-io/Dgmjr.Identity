...
//         s switch
//         {
//             string str when str is nameof(Create) => Create.Instance,
//             string str when str is nameof(Read) => Read.Instance,
//             string str when str is nameof(Update) => Update.Instance,
//             string str when str is nameof(Delete) => Delete.Instance,
//             string str when str is nameof(All) => All.Instance,
//             string str when str is Create.DisplayName => Create.Instance,
//             string str when str is Read.DisplayName => Read.Instance,
//             string str when str is Update.DisplayName => Update.Instance,
//             string str when str is Delete.DisplayName => Delete.Instance,
//             string str when str is All.DisplayName => All.Instance,
//             string str when str is Create.Description => Create.Instance,
//             string str when str is Read.Description => Read.Instance,
//             string str when str is Update.Description => Update.Instance,
//             string str when str is Delete.Description => Delete.Instance,
//             string str when str is All.Description => All.Instance,
//             string str when str is Create.ShortName => Create.Instance,
//             string str when str is Read.ShortName => Read.Instance,
//             string str when str is Update.ShortName => Update.Instance,
//             string str when str is Delete.ShortName => Delete.Instance,
//             string str when str is All.ShortName => All.Instance,
//             string str when str is Create.UriString => Create.Instance,
//             string str when str is Read.UriString => Read.Instance,
//             string str when str is Update.UriString => Update.Instance,
//             string str when str is Delete.UriString => Delete.Instance,
//             string str when str is All.UriString => All.Instance,
//             // string str when str is Create.GuidString => Create.Instance,
//             // string str when str is Read.GuidString => Read.Instance,
//             // string str when str is Update.GuidString => Update.Instance,
