...
public class AppRoleConfiguration<TUser, TRole, TKey, TUserClaim, TUserRole,
                            ...
                            IIdentityClaimValueType<TKey, TUser, TRole, TClaimType, TClaimValueType>
{
    ...
    {
        builder.ToTable(Role, IdentitySchema.ShortName, tb =>
        {
        ...
        // builder.HasIndex(e =>
        // e.NormalizedName).IsUnique().HasName("RoleNameIndex").HasFilter("[NormalizedName]
        // IS NOT NULL");
...
public class AppRoleConfiguration
    : AppRoleConfiguration<AppUser, AppRole, long, AppUserClaim, AppUserRole,
