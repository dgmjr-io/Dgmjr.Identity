...
protected override void ConfigureConventions(ModelConfigurationBuilder configurationBuilder)
{
    ...
    configurationBuilder
        ...
        .HaveMaxLength(8)
        .AreUnicode(false)
        .HaveConversion<Gender.EfCoreValueConverter>();
    configurationBuilder
    ...
    // configurationBuilder.DefaultTypeMapping<IStringDictionary>(
    ...
    // configurationBuilder.DefaultTypeMapping<IGender>(
    //     b => b.HasConversion<Gender.EfCoreValueConverter>()
    // );
}
